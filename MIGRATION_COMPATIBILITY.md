...
- Realtime updates: `/socket.io/socket.io.js` is still a polling compatibility shim. The old Node WUI's realtime Socket.IO push semantics, event ordering, and reconnect behavior are not fully reproduced.
