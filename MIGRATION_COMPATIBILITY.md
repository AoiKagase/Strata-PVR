...
| Native Strata PVR frontend rewrite | partially compatible; dependency-free dashboard, core reservation/recording/recorded actions, and JSON-based rule actions added under `web/`, but full legacy WUI workflow coverage is incomplete. |
