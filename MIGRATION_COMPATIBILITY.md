...
| Native Strata PVR frontend rewrite | partially compatible; dependency-free dashboard added under `web/`, but full legacy WUI workflow coverage is incomplete. |
