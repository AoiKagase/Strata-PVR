...
| Native Strata PVR frontend rewrite | partially compatible; dependency-free dashboard, core reservation/recording/recorded actions, JSON-based rule actions, and log panels added under `web/`, but full legacy WUI workflow coverage is incomplete. |
